...
public class loginFormSocketTest extends JDialog {
        ...
        btnLogin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(loginFormSocketTest.this, ex.getMessage(), "Greska", JOptionPane.ERROR_MESSAGE);
                }
...
//
    ...
    public static void main(String[] args) {
        loginFormSocketTest dialog = new loginFormSocketTest();
